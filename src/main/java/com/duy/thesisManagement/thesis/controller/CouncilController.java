...
//    }
    ...
    @PutMapping("/council/{id}/active")
    public ResponseEntity<String> activeCouncil(@PathVariable(value = "id") Integer id) {
        this.councilService.activeCouncil(id);
        return ResponseEntity.ok("Successfully soft active council");
    }
}
