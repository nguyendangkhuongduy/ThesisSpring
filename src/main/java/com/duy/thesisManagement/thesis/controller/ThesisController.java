...
//    }
    ...
    @PutMapping(path = "/thesis/action/putTopic/{id}")
    public ResponseEntity<String> PutTopic(@PathVariable(value = "id") Integer id,
                                          @Valid @RequestBody ThesisPutTopicDTO thesisPutTopicDTO) {
        this.thesisService.putTopic(id, thesisPutTopicDTO);
        return ResponseEntity.ok("Successfully put topic");
    }

    @PutMapping(path = "/thesis/action/putCheck/{id}")
    public ResponseEntity<String> PutCheck(@PathVariable(value = "id") Integer id,
                                          @Valid @RequestBody CheckTheisDTO checkDTO) {
        this.thesisService.putCheck(id, checkDTO);
        return ResponseEntity.ok("Successfully check");
    }
